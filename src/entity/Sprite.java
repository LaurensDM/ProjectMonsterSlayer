...
public class Sprite {
    ...
    public Sprite(String entity) {
        if (entity.equals("merchant")) {
            images = new Image[2];
            images[0] = new Image(getClass().getResourceAsStream("/images/sprite/merchant_down_1.png"));
            images[1] = new Image(getClass().getResourceAsStream("/images/sprite/merchant_down_2.png"));
        } else {
