...
public class Player {
	...
	public Player(String name, String wachtwoord, String affinity, int level, int exp, int money, List<Items> bag, Skills skills) {
		setName(name);
	...
	public Player(String name, String wachtwoord, String affinity) {
		this(name, wachtwoord, affinity, 1, 0, 100, new ArrayList<>(),new Skills());
	}
